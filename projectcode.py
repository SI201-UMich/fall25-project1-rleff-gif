...
# Date: October 9, 2025
# Video: https://www.loom.com/share/a1601c06384041379939c58547c9eac0
...
# Use a path relative to this script so the file can be opened regardless of the current
# working directory when the script is run.
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
CSV_PATH = os.path.join(BASE_DIR, 'data', 'Coffe_sales.csv')
